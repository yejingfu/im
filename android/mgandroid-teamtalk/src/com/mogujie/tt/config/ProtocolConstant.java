...
//					commandString, commandId, seqNo);
	...
	// LOGIN IP,PORT
	public static final String LOGIN_IP1 = "182.92.149.11"; // "122.225.68.125";
	public static final String LOGIN_IP2 = "182.92.149.11"; //"101.68.218.125";	
	//open source
	public static final int LOGIN_PORT = 8610; //18610; //18008;
